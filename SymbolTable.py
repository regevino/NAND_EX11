class SymbolTable:
    ...
    def __init__(self):
        ...
        self.KIND_TO_TABLE = {Symbol.STATIC: self.__class_table, Symbol.FIELD: self.__class_table, Symbol.LOCAL: self.__subroutine_table, Symbol.ARGS: self.__subroutine_table}

    def register_symbol(self, name: str, type: str, kind: str):
        """
        ...
        new_symbol = Symbol(name, type, kind, self.__kind_count[kind])
